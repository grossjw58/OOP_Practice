...
It should initialize a deck instance variable to a DeckOfCards and shuffle it.
...
Use the deck's deal_card() method to deal 5 cards and append them to a new list. Return the new list.
'''
